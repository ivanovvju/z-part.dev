                                ...
                                <div class="table" style="margin-top: 40px">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 10px 0 10px 30px"><b>Ссылка</b></td>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @foreach($history as $item)
                                            <tr>
                                                ...
                                                <td style="padding: 10px 30px 10px 0">{{ $item->title }}.zip</td>
                                                <td style="padding: 10px 0 10px 0">{{ $item->created_at }}</td>
                                                <td style="padding: 10px 0 10px 30px"> <a href="{{ route('download', ['file' => $item->title]) }}">Скачать файл Excel</a></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
